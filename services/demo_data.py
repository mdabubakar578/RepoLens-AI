...
REPOLENS_COMMITS = [
    _commit(
        "a18c92f",
        "Implement repository Q&A with retrieved source evidence",
        "RepoLens Team",
        "2026-07-15T10:15:00",
        "feature",
    ),
    _commit(
        "b21d44a",
        "Add AST-based Python chunking for RAG context",
        "RepoLens Team",
        "2026-07-15T13:20:00",
        "feature",
    ),
    _commit(
        "c76b910",
        "Add Gemini timeout handling and retrieval fallback",
        "RepoLens Team",
        "2026-07-16T09:05:00",
        "bugfix",
    ),
    _commit(
        "d42f884",
        "Detect repository technologies and architecture patterns",
        "RepoLens Team",
        "2026-07-16T15:30:00",
        "feature",
    ),
    _commit(
        "e82a191",
        "Improve history cards and Q&A evidence drawer",
        "RepoLens Team",
        "2026-07-17T11:10:00",
        "refactor",
    ),
    _commit(
        "f31c728",
        "Prepare production WSGI entrypoint",
        "RepoLens Team",
        "2026-07-17T16:00:00",
        "devops",
        tags=["v2.0.0"],
...
TASKFLOW_COMMITS = [
    _commit(
        "9ac1021",
        "Create Flask task API and SQLite schema",
        "Demo Maintainer",
        "2026-06-25T09:00:00",
        "feature",
    ),
    _commit(
        "b884fc0",
        "Add dashboard filters for task status and owner",
        "Demo Maintainer",
        "2026-06-26T14:25:00",
        "feature",
    ),
    ...
    _commit(
        "e1029aa",
        "Add onboarding notes for local development",
        "Demo Maintainer",
        "2026-06-28T12:10:00",
        "docs",
    ),
    _commit(
        "f09bc77",
        "Refactor service layer around task repository helpers",
        "Demo Maintainer",
        "2026-07-01T17:15:00",
        "refactor",
    ),
        ...
        "milestones": [
            {
                "tag": "v2.0.0",
                "commit": "f31c728",
                "message": "Prepare production WSGI entrypoint",
            }
        ],
        ...
        "extended_data_json": json.dumps(
            {
                ...
                "technologies": {
                    ...
                    "dependencies": {
                        "python": ["flask", "google-genai", "gunicorn", "python-dotenv"]
                    },
                    ...
                    "risk_items": [
                        {
                            ...
                            "severity": "LOW",
                            "confidence": 0.74,
                            "title": "Hosted demo uses free-tier resources",
                            "description": "Long-running repository analysis may be slower on a free web service.",
                        }
                    ],
                    "complexity_metrics": {
                        "complexity_score": 38,
                ...
                "architecture": {
                    "patterns": [
                        {
                            "name": "Layered",
                            "confidence": 0.86,
                            "description": "Routes, services, templates, and persistence are separated by responsibility.",
                            "evidence": ["pages/", "services/", "components/"],
                        },
                        {
                            "name": "Monolith",
                            "confidence": 0.72,
                            "description": "A single Flask application coordinates the UI and analysis pipeline.",
                            "evidence": ["app.py", "wsgi.py"],
                        },
                    ],
                    "modules": [
                        {
                    ...
                    "insights": [
                        "Repository analysis is separated into service modules.",
                        "Q&A uses retrieval before generation.",
                        "Result pages reuse stored analysis metadata.",
                    ],
                },
            }
        ),
        ...
        "extended_data_json": json.dumps(
            {
                "metadata": {
                    ...
                    "forks": 2,
                    "default_branch": "main",
                    "description": "Demo task management backend",
                },
                "technologies": {
                    "technologies": [
                        {"name": "Python", "category": "language", "confidence": 1.0},
                    ...
                    "todos": [
                        {
                            ...
                            "line": 44,
                            "type": "TODO",
                            "text": "Add pagination for larger task lists",
                        }
                    ],
                    "hotspots": [
                        {
                    ...
                    "risk_items": [
                        {
                            ...
                            "description": "A TODO marker suggests larger task lists need pagination.",
                        }
                    ],
                    "complexity_metrics": {
                        "complexity_score": 26,
                ...
                "architecture": {
                    "patterns": [
                        {
                            "name": "Layered",
                            "confidence": 0.78,
                            "description": "Routes delegate task operations to service helpers.",
                            "evidence": ["services/", "templates/"],
                        }
                    ],
                    "modules": [
                        {
                    ...
                    "insights": [
                        "The service layer centralizes task operations.",
                        "Commit history shows a move from features to cleanup.",
                    ],
                },
            }
        ),
